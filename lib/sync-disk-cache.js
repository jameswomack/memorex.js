...
function Cache (key, _) {
  // TODO ~ create structural sharing for Caches that have the same root, compression & key
  var options = _ || {};
...
Cache.CompressionTypes = kk(Object.keys(COMPRESSIONS))
